# Contributing to `ra-language-intl`

Love ra-language-intl and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/yeutech-lab/ra-language-intl/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/ra-language-intl.git
   # Navigate to the newly cloned directory
   cd ra-language-intl
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/kopax/ra-language-intl.git
   ```
...
owners to license your work under the terms of the [MIT License](https://github.com/yeutech-lab/ra-language-intl/blob/master/LICENSE.md).
